...
#define RQ_SET_ADDRESS              0x05
#define RQ_GET_DESCRIPTOR           0x06
#define RQ_SET_DESCRIPTOR           0x07
#define RQ_GET_CONFIGURATION        0x08
#define RQ_SET_CONFIGURATION        0x09
#define RQ_GET_INTERFACE            0x0A
#define RQ_SET_INTERFACE            0x0B
#define RQ_SYNC_FRAME               0x0C
/*
 * base descriptor
 */
